    ...
    internal class Ship : GameObject
    {
        ...
        float y = pos.Y;
            ...
            if(Keyboard.IsKeyPressed(Keyboard.Key.Space) && _fireTimer <= 0)
            {
                ...
                float laserX0 = x + bounds.Width;
                float laserY0 = y + bounds.Height / 6.0f;
                Laser laser0 = new Laser(new Vector2f(laserX0, laserY0));
                Game.CurrentScene.AddGameObject(laser0);
            }
        }
    }
}
